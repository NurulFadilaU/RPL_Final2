                        ...
                        <table class="w-full table-auto border-collapse mt-4">
                            <thead>
                                <tr class="text-center border-b border-orange-500">
                                    ...
                                    <th class="p-2 text-center border border-orange-500">Opsi</th>
                                </tr>
                            </thead>
                                ...
                                @forelse ($kegiatan as $item)
                                    <tr class="border-b border-orange-500  text-sm">
                                        ...
                                        <td rowspan="2" class="text-center p-2 border border-orange-500">
                                            <!-- Tombol Edit -->
                                            <a
                                                href="{{ route('pjdaftarkegiatan.edit', ['kegiatan' => $item->id_kegiatan]) }}"class="inline-block mr-2">
    ...
    <script>
        ...
        function confirmDelete(id) {
            ...
            Swal.fire({
                ...
                customClass: {
                    popup: 'w-50px h-30px rounded-lg bg-gradient-to-b from-yellow-400 to-yellow-500 p-4 shadow-xl',
                    title: 'text-white text-sm font-semibold', // Ukuran teks judul lebih kecil
