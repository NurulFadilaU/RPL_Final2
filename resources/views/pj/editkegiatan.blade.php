    ...
    <div class="grid grid-cols-[250px_1fr] h-screen">
        ...
        <div class="flex flex-col overflow-y-auto">
            ...
            <main class="px-6 py-4">
                <h2 class="text-2xl font-bold text-orange-500 mb-6">Form Edit Kegiatan</h2>
                ...
                <form action="{{ route('kegiatan.update', $kegiatan->id_kegiatan) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_kegiatan" id="nama_kegiatan"
                            value="{{ $kegiatan->nama_kegiatan }}" class="border p-2 w-full" required>
                    </div>

                    <!-- Input Nama Tim -->
                    <div class="mb-4">
                        <label for="nama_tim" class="block text-sm font-medium">Nama Tim</label>
                        <input type="text" name="nama_tim" id="nama_tim" value="{{ $kegiatan->tim->nama_tim }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="mulai" id="mulai" value="{{ $kegiatan->tanggal_mulai }}"
                            class="border p-2 w-full" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="berakhir" id="berakhir" value="{{ $kegiatan->tanggal_berakhir }}"
                            class="border p-2 w-full" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="target" id="target" value="{{ $kegiatan->target }}"
                            class="border p-2 w-full" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="realisasi" id="realisasi" value="{{ $kegiatan->realisasi }}"
                            class="border p-2 w-full" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="satuan" id="satuan" value="{{ $kegiatan->satuan }}"
                            class="border p-2 w-full" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status" id="status" class="border p-2 w-full" required>
                            <option value="1" {{ $kegiatan->status == 1 ? 'selected' : '' }}>Belum Selesai
                            </option>
                            <option value="0" {{ $kegiatan->status == 0 ? 'selected' : '' }}>Selesai</option>
                        </select>
                    </div>
